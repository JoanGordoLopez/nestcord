...
import { Apple, ChartNoAxesColumn, Heart, MessageCircle, Moon, Sun } from "lucide-react"
      ...
      <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-6 w-full max-w-sm">
        ...
        <div className="flex items-start gap-4 mb-4">
          ...
          <div className="flex-1">
            <div className="text-sm font-semibold text-gray-900 dark:text-white">Nestcord</div>
            <div className="text-xs text-gray-500 dark:text-gray-400">@nestcord • Less than a minute ago</div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          Who else loves views like this? 👀 <span className="text-blue-500 dark:text-blue-300">#NaturePhotography</span>
          </p>
          
          <div className="h-40 bg-gray-200 dark:bg-gray-700 rounded-xl overflow-hidden">
            <Image
              src="/assets/post-attachment.png"
              alt="Post Image"
              width={400}
              height={200}
          ...
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 bg-indigo-500 dark:bg-indigo-900 rounded-full flex items-center justify-center">
              <span className="text-white text-sm"><Heart className="h-4 w-4 "/></span>
            </div>
            <div className="text-gray-600 dark:text-gray-300 text-sm">102 Likes</div>
          </div>
        ...
        <div className="flex-1 flex flex-col justify-center">
          <div className="max-w-md space-y-8">
            <div>
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-white">What&apos;s happening now?</h1>
              <p className="mt-3 text-xl text-gray-600 dark:text-gray-300">Join Nestcord today.</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <Button variant="outline" disabled={true} className="w-full bg-indigo-500 hover:bg-indigo-600 text-white font-medium py-6 text-base transition-colors">
                Create account
              </Button>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-4">
                ...
                and{" "}
                <Link href="/policy" className="text-indigo-400 hover:underline">
                  Privacy Policy
                </Link>
                .
              </p>
            ...
            <div className="pt-4">
              <p className="text-base dark:text-white">
                ...
                <Button onClick={handleSession} variant="link" className="text-indigo-500 hover:underline font-medium">
                  Log In
                </Button>
              </p>
            </div>
