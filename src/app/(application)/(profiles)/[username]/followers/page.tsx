...
import { FollowersContent } from "@/components/profile/followers/followers-content"
...
export async function generateMetadata({
    ...
    try {
        ...
        return {
            title: `People following ${user.name} (@${user.username}) | Nestcord`,
            description:
                user.biography || `People following ${user.name} (@${user.username}) on Nestcord`,
            openGraph: {
