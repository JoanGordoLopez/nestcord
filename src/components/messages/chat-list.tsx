  ...
  const chatUsers =
    data?.chats?.map((chat) => {
      ...
      return {
        ...
        lastMessageTime: formatTimeDistance(
      ...
      >
        ...
        <div className="p-3">
          <div className="relative">
            ...
            <Input
              placeholder={
                activeTab === "chats" ? "Search chats" : "Search unread chats"
              }
              className="pl-8"
              value={searchQuery}
            ...
            <div className="space-y-1 p-2">
              {filteredRequests.length > 0 ? (
                <>
                  <div className="px-2 py-3">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Messages from people you have not responded to yet
                    </p>
                  </div>
                  {filteredRequests.map((request) =>
                    renderUserItem(request, true),
                  )}
                </>
              ) : (
                <div className="flex flex-col items-center justify-center p-8 text-center">
                  ...
                  <p className="text-xs text-muted-foreground">
                    When someone sends you a request message, or you do not
                    reply to a message, it will appear here
                  </p>
                </div>
              )}
            </div>
