...
import StatusPost from "../status/status-post";
      ...
      <div className="sticky top-0 z-10 bg-white dark:bg-background backdrop-blur">
        ...
        <Tabs defaultValue="home" className="w-full">
          <TabsList className="grid w-full grid-cols-2 bg-transparent">
            <TabsTrigger
              value="home"
              className="rounded-none data-[state=active]:border-dashed data-[state=active]:border-indigo-500 data-[state=active]:bg-transparent data-[state=active]:shadow-none"
            >
              Home
            </TabsTrigger>
            <TabsTrigger
